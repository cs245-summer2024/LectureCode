public class BST<T extends Comparable> {
    public static class BSTNode<T extends Comparable>{
        ...
        public BSTNode getSuccessor(){
            ...
            /*
               If our runner 'traverser' gets to the root node, that means there is no sucessor to the
               node. The only other way the loop terminates is if we go up a left branch.
             */
            while(traverser.parent != null && traverser != traverser.parent.left){
